...
c = MongoClient()
database_name = rospy.get_param("~database_name", "interfacesystech_log")
db = c[database_name]
...
if __name__ == "__main__":
    rospy.init_node("interfacesystech_logger_node")
    sub = rospy.Subscriber("/interfacesystech_log", LogRecord,
